...
export const MAJOR_INDONESIAN_CITIES = [
  { name: "Jakarta", lat: -6.1754, lng: 106.8272, icon: "🗼" },
  { name: "Bandung", lat: -6.9175, lng: 107.6191, icon: "☕" },
  { name: "Semarang", lat: -7.0051, lng: 110.4381, icon: "⛪" },
  { name: "Yogyakarta", lat: -7.7956, lng: 110.3695, icon: "🕌" },
  { name: "Surabaya", lat: -7.2575, lng: 112.7521, icon: "🦈" },
  { name: "Medan", lat: 3.5952, lng: 98.6722, icon: "🏢" },
  { name: "Jambi", lat: -1.6018, lng: 103.6181, icon: "🌴" },
  { name: "Makassar", lat: -5.1477, lng: 119.4327, icon: "🌇" },
